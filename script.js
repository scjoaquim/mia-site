...
(function () {
  ...
  // [S4 - 12-Ago-2026] singular. Com UMA posicao - que e o caso no dia do lancamento -
  // lia-se "1 posicoes . 1 abertos" e "1 de 1 mercados abertos", nas duas linguas.
  // Em pt, "posicao" e feminino: o par certo e "1 aberta" / "2 abertas".
  function cntTxt(n, o) {
    return en ? (n + (n === 1 ? ' position' : ' positions') + ' · ' + o + ' open')
              : (n + (n === 1 ? ' posição'  : ' posições')  + ' · ' + o + (o === 1 ? ' aberta' : ' abertas'));
  }
  function mktTxt(o, n) {
    return en ? (o + ' of ' + n + (n === 1 ? ' market open'    : ' markets open'))
              : (o + ' de ' + n + (n === 1 ? ' mercado aberto' : ' mercados abertos'));
  }
